...
def get_parameter():
    ...
    parser.add_argument('--weight_decay', type=float, default=0.005, help='Weight decay for AdamW if we apply some.')
    parser.add_argument('--adam_epsilon', type=float, default=1e-8, help='Epsilon for AdamW optimizer.')
    parser.add_argument('--max_grad_norm', type=float, default=0.75, help='Max gradient norm.')
    ...
    parser.add_argument('--max_len', type=int, default=256, help='the max length of the text.')
